...
const Intro = () => {
  const tech = [
    ...
    { id: 4, name: "Node.js", designation: "Cross-Platform Javascript Enviroment fior creating serverside applications ", image: nodeImg },
  ...
  return (
    <div className="flex flex-col items-center h-screen w-full p-4 sm:p-6 lg:p-10">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-center justify-center items-center lg:items-center  h-[50%] w-[100%]">
        ...
        {/* Tooltip Section */}
        <div className="flex flex-col items-center justify-around w-full sm:w-[50%] h-[50%]  p-4 lg:p-0">
        <h2 className="text-xl text-center sm:text-2xl lg:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-green-500 to-teal-500 ">
